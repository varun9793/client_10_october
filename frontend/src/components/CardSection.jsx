    ...
    <div className="py-16 bg-gradient-to-r from-blue-50 to-indigo-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-20 text-center"> {/* Centered and responsive */}
          <h2 className="text-4xl sm:text-5xl lg:text-3xl font-bold text-white inline-block px-6 py-4 bg-gradient-to-r from-indigo-500 to-purple-600 rounded-md shadow-md transform hover:scale-105 transition duration-300 ease-in-out">
